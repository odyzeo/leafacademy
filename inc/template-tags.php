...
function leafacademy_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<?php if(is_single()) : ?>
           <?php/*
			<div class="leaf-share-under-article">
				<div class="leaf-share-under-article-content">
					<div class="leaf-share-under-article-title">Share on social media::</div>
					<div class="leaf-share-under-article-items">
						<div class="leaf-share-under-article-items-item">
							<div class="fb-like" data-href="<?php the_permalink();?>" data-width="auto" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
						</div>
						<div class="leaf-share-under-article-items-item">
...
function leafacademy_inline_featured_image($attachmentId) {
    ...
    if ($thumbnail_image && isset($thumbnail_image[0])) {
        ...
        if ($description) $res .= '<span class="post-thumbnail-description">'.$description.'</span>';
