                    ...
                    <div class="entry-content">
                        ...
                        ?>
                         <ul class="lfa-single-article-additional-links">
                            <li>
                                <a href="<?php echo esc_attr($author->getUrl());?>">More articles from this author</a>
                            </li>
                            <?php if($categories):?>
                                <li>
                                    <span class="pipe">|</span> <a href="<?php echo get_term_link(reset($categories));?>">More articles from this category</a>
                                </li>
                            <?php endif;?>
                            <!-- <li> <span class="pipe">|</span> <span>Please share and follow us:</span><?php echo DISPLAY_ULTIMATE_PLUS(); ?></li> -->
                        </ul>
                    </div><!-- .entry-content -->
